// icons.jsx — Custom Certus icon set (replaces emoji)
// Cohesive geometric line icons, 24×24, rounded caps/joins.
// Each takes { size, stroke (color), sw (stroke width), fill (duotone accent) }.
...
const IconMicroscope = (p) => ic((fill) => (<>
  <path d="M6 18h11" />
...
const IconLock = (p) => ic((fill) => (<>
  <rect x="5.5" y="10.5" width="13" height="9" rx="2.5" fill={fill} />
  <path d="M8.5 10.5V8a3.5 3.5 0 0 1 7 0v2.5" />
  <path d="M12 14v2.2" />
</>), p)

const IconCheck = (p) => ic(() => (<path d="m5 12.5 4.5 4.5L19 6.5" />), p)
const IconX = (p) => ic(() => (<><path d="M6.5 6.5 17.5 17.5M17.5 6.5 6.5 17.5" /></>), p)
const IconArrowLeft = (p) => ic(() => (<><path d="M19 12H5M11 6 5 12l6 6" /></>), p)
const IconArrowRight = (p) => ic(() => (<><path d="M5 12h14M13 6l6 6-6 6" /></>), p)
const IconClock = (p) => ic((fill) => (<><circle cx="12" cy="12" r="8" fill={fill} /><path d="M12 7.5V12l3 1.8" /></>), p)

// ── Menu / settings ────────────────────────────────────────────────────
const IconChevron = (p) => ic(() => (<path d="m6 9.5 6 6 6-6" />), p)
const IconBell = (p) => ic((fill) => (<>
  <path d="M6 16.5V11a6 6 0 0 1 12 0v5.5l1.6 2H4.4Z" fill={fill} />
  <path d="M10 19.5a2 2 0 0 0 4 0" />
</>), p)
const IconSliders = (p) => ic((fill) => (<>
  <path d="M4 8h10M18 8h2M4 16h2M10 16h10" />
  <circle cx="16" cy="8" r="2.4" fill={fill} />
  <circle cx="8" cy="16" r="2.4" fill={fill} />
</>), p)
const IconLogout = (p) => ic(() => (<>
  <path d="M14 7.5V6a2 2 0 0 0-2-2H6a2 2 0 0 0-2 2v12a2 2 0 0 0 2 2h6a2 2 0 0 0 2-2v-1.5" />
  <path d="M10 12h10M17 9l3 3-3 3" />
</>), p)

// Map of exam/area id → icon, for convenience
const ICONS = {
...
Object.assign(window, {
  IconCap, IconMicroscope, IconColumns, IconCompass, IconPuzzle, IconBook,
  IconPencil, IconChat, IconHash, IconBooks, IconGlobe, IconTarget, IconScale,
  IconSignal, IconFlame, IconChart, IconSpark, IconLock, IconCheck, IconX,
  IconArrowLeft, IconArrowRight, IconClock, ICONS,
  IconChevron, IconBell, IconSliders, IconLogout,
})
