...
function LogoMini({ height, width, style }) {
  return (
    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 1400 290"
      ...
      <path fill="#8fa88b" d="M188.54,269.05s-1.09-9.67-26.68-18.86c-25.59-9.2-82.34-7.28-110.3-83.91C23.6,89.65,105.7,27.65,105.7,27.65c0,0-65.48,42.87-64.99,97.1.48,54.22,27.46,116.37,114.11,129.96,23.17,7.77,20.23,12.85,25.22,19.72,4.98,6.87,8.5-5.38,8.5-5.38Z"/>
      ...
      {/* Texto CERTUS — Montserrat Bold 250px, proporciones correctas */}
      <text fill="#4a433e" fontFamily="'Montserrat', sans-serif" fontSize="250" fontWeight="700" transform="translate(324.72 235.19)">
        <tspan x="0" y="0">CE</tspan>
        <tspan x="350.99" y="0" letterSpacing="0">R</tspan>
        <tspan x="532.24" y="0" letterSpacing="-.01em">T</tspan>
        <tspan x="683.74" y="0">US</tspan>
      </text>
    </svg>
  )
}
